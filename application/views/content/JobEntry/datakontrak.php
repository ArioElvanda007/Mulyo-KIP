                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!-- <button type="button" data-toggle="modal" data-target="#modal-JamPel" class="btn btn-success btn-xs pull-right"><i class="fa fa-plus">&nbsp Tambah Data </i></button> -->
                                <hr>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!-- <button type="button" data-toggle="modal" data-target="#modal-JamUm" class="btn btn-success btn-xs pull-right"><i class="fa fa-plus">&nbsp Tambah Data </i></button> -->
                                <hr>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!-- <button type="button" data-toggle="modal" data-target="#modal-JamPemeliharaan" class="btn btn-success btn-xs pull-right"><i class="fa fa-plus">&nbsp Tambah Data </i></button> -->
                                <hr>
                            </div>
                                      ...
                                      <div class="control-group after-add-more">
                                        <ul class="todo-list">
                                          ...
                                          <li>
                                            ...
                                            <!-- <button type="button" class="btn btn-success btn-xs pull-right add-more">Tambah Item</button> -->
                                          </li>
                         ...
                         <!-- <li style="hidden">
                            ...
                            <div class="copy hide">
                                <div class="control-group">
                                        ...
                                        &nbsp &nbsp<input type="checkbox" value=" <span><input type="text" class="form-control"></span>

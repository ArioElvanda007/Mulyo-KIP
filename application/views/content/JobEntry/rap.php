                ...
                <div class="form-group">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table id="TblSumda" class="table table-hover table-bordered table-striped" border="1" cellspacing="2" width="100%">
                            ...
                            <colgroup span="3"></colgroup>
                            <tr>
                                <td rowspan="2" style="background-color:darkgoldenrod ;"><center>No</center></td>
                                <td rowspan="2" style="background-color:darkgoldenrod ;"><center>Kode SUMDA</center></td>
                                <td rowspan="2" style="background-color:darkgoldenrod ;"><center>Uraian Pekerjaan</center></td>
                                <td rowspan="2" style="background-color:darkgoldenrod ;"><center>Koef</center></td>
                                <td rowspan="2" style="background-color:darkgoldenrod ;"><center>Sat</center></td>

                                <th colspan="3" scope="colgroup" style="background-color:darkgoldenrod ;"><center>KONTRAK AWAL</center></th>
                                <th colspan="5" scope="colgroup" style="background-color:darkgoldenrod ;"><center>RAP 1.1</center></th>

                                <td rowspan="2"style="background-color:darkgoldenrod ;"><center>Aksi</center></td>
                            </tr>
                            <tr>
                                <th scope="col" style="background-color: deepskyblue;"><center>Kontrak </p>Awal</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>H.Satuan</p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>Jml Harga </p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>Upah/Jasa </p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>Material </p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>Alat </p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>RAP 1.1 </p>(Rp)</center></th>
                                <th scope="col" style="background-color: deepskyblue;"><center>Jml Harga </p>(Rp)</center></th>
                            </tr>
